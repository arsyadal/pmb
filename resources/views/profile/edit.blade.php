...
<div class="min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-6 py-3">
        <div class="flex justify-between items-center">
            <a href="{{ route('mahasiswa.index') }}" class="text-xl font-bold">Mahasiswa Dashboard</a>
            <div class="flex space-x-4 items-center">
                <a href="{{ route('mahasiswa.index') }}" class="text-gray-700 hover:text-gray-900">Home</a>
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    @if($user->profile_picture)
                        <img src="{{ asset('storage/images/' . $user->profile_picture) }}" alt="Profile Picture" class="mt-4 w-32 h-32 rounded-full">
                    @endif
                </div>
