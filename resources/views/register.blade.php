        ...
        <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
            ...
            <form action="{{ route('admin.store') }}" method="POST" class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    <input type="text" id="alamat_ktp" name="alamat_ktp" class="input input-bordered w-full" value="{{ old('alamat_ktp') }}">
                </div>
                <div class="form-control">
                    <label class="label" for="alamat_saat_ini">
                        <span class="label-text">Alamat Saat Ini</span>
                    </label>
                    <input type="text" id="alamat_saat_ini" name="alamat_saat_ini" class="input input-bordered w-full" value="{{ old('alamat_saat_ini') }}">
                </div>
    ...
    <select id="kabupaten" name="kabupaten" class="select select-bordered w-full">
        <option value="">{{ __('Pilih Kabupaten') }}</option>
                ...
                <div class="form-control">
                    ...
                    <input type="text" id="nomor_telepon" name="nomor_telepon" class="input input-bordered w-full" value="{{ old('nomor_telepon') }}">
                </div>
                <div class="form-control">
                    <label class="label" for="nomor_hp">
                        <span class="label-text">Nomor HP</span>
                    </label>
                    <input type="text" id="nomor_hp" name="nomor_hp" class="input input-bordered w-full" value="{{ old('nomor_hp') }}">
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="input input-bordered w-full" value="{{ old('tanggal_lahir') }}">
                </div>
                <div class="form-control">
                    <label class="label" for="tempat_lahir">
                        <span class="label-text">Tempat Lahir</span>
                    </label>
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="input input-bordered w-full" value="{{ old('tempat_lahir') }}">
                </div>
                <div class="form-control">
